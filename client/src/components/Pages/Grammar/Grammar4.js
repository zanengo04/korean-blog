...
export default function Grammar4() {
    return (
        <main>
            <h1>
            Conjugating 있다 and 있다</h1>
            <p>
있다 is one of the most complex and versatile words in Korean. Unfortunately, it is also one of the most common words. It is often very difficult for learners of a language to fully understand some of the most commonly used words in whatever language they are studying. For example, a native English speaker might think that the word “the” is one of the easiest words as it is used so frequently. However, try explaining the meaning and purpose of “the” to a Korean person and you will quickly discover that its usage is very complex.
<br /><br />
있다 can be an adjective, or it can be a verb. Whether it is an adjective or a verb depends on its usage.
<br /><br />
있다 is an adjective when it is used to indicate that one “has” something. You learned these sentences:
<ul>
    <li>나는 펜이 있다 = I have a pen</li>
    <li>나는 차가 있다 = I have a car</li>
    <li>나는 가방이 있다 = I have a bag</li>
</ul>
...
<br /><br />
When 있다 is used to indicate that something/someone is “at/in” a location, it is also an adjective. This is also very difficult for an English speaker to wrap their head around. You learned these sentences in:
<ul>
    <li>나는 은행 안에 있다 = I am inside the bank</li>
    <li>개는 집 안에 있다 = The dog is in the house</li>
    <li>고양이는 의자 밑에 있다 = The cat is under the chair</li>
</ul>
